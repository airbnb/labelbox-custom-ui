(function () {
	...
	*/
	...
	function App() {
	  ...
	  var handleAssetChange = react.exports.useCallback( /*#__PURE__*/function () {
	    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(asset) {
	      var assetDataStr, assetImagesStr, parsedAssetImages, label;
	      return _regeneratorRuntime().wrap(function _callee$(_context) {
	        while (1) switch (_context.prev = _context.next) {
	          case 0:
	            ...
	            _context.next = 8;
	            return get(asset.data).then(function (x) {
	              return x.text();
	            });
	          case 8:
	            assetDataStr = _context.sent;
	            console.log(assetDataStr);
	            assetImagesStr = get(asset.metadata[0].metaValue);
	            parsedAssetImages = parseHtmlInput(assetImagesStr); // Full match will be first element, listing ID will be second
